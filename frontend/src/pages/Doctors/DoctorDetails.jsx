                ...
                <div className='grid md:grid-cols-3 gap-[50px]'>
                    <div className='md:col-span-2'>
                        ...
                        <div className='mt-[50px] border-b border-solid border-[#00000034]'>
                            <button onClick={() => setTab('about')} className={`py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold ${tab === 'about' ? 'border-b border-solid border-primaryColor' : ''}`}>О Докторе</button>
                            <button onClick={() => setTab('feedback')} className={`py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold ${tab === 'feedback' ? 'border-b border-solid border-primaryColor' : ''}`}>Обратная связь</button>
                        </div>
